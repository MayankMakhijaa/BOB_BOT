...
class myBOBBot:
    ...
    #     if myBOBBot.is_function_calling != 8:
    ...
    #         myBOBBot.is_function_calling = 8
    # @tool(infer_schema=False)
    ...
    #     if myBOBBot.is_function_calling != 1:
    ...
    #         ob1.message.append(SystemMessage(content=f"{text}"))
    #         ob1.message.append(HumanMessage(content=ob1.user_input))
    #         myBOBBot.is_function_calling = 1
    ...
    def open_government_account(self,*args, **kwargs):
        ...
        if myBOBBot.is_function_calling != 2:
    ...
    def open_wms_account(self,*args, **kwargs):
        ...
        if myBOBBot.is_function_calling != 11:
            ...
            self.message.append(SystemMessage(content=f"{text}"))
            self.message.append(HumanMessage(content=self.user_input))
            myBOBBot.is_function_calling = 11

   
    def all_BoB_information(self,*args, **kwargs):
    ...
    async def run_conversation(self, user_input):
        ...
        prompt = ChatPromptTemplate.from_messages(
            [
                ("system", "You are a very powerful Bank of Baroda assistant."),
